...
const Gallery = () => {
  return (
    <section className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3  mt-9 md:mt-24 border border-red-600">
      {GALLERIES.map((gallery, idx) => (
        <div key={idx} className="group [perspective:1000px] w-full">
          <div className="relative w-full aspect-[4/3] transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
            ...
            <div className="absolute inset-0 bg-[#0F75BC] text-white  p-4 flex items-center justify-center text-center [transform:rotateY(180deg)] [backface-visibility:hidden]">
