...
const WhyUs = () => {
  return (
    <Container>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-9 md:mt-28 montserrat gap-3 md:gap-8 md:px-14">
        {WHYUS?.map((params, idx) => (
          <div className="bg-lightSilver px-5 py-12 rounded-lg text-center" key={idx}>
